          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="card p-6">
                ...
                <div className="space-y-3">
                  {PAYMENT_METHODS.map((m) => (
                    <label key={m.value} className={`flex items-center gap-3 p-4 border-2 rounded-xl cursor-pointer transition-colors ${paymentMethod === m.value ? 'border-orange-500 bg-orange-50 dark:bg-orange-900/20' : 'border-gray-200 dark:border-gray-700 hover:border-gray-300'}`}>
              ...
              <div className="card p-6">
                ...
                <textarea rows={3} value={notes} onChange={(e) => setNotes(e.target.value)}
                  className="input resize-none" placeholder="Any special instructions for delivery..." />
              </div>
            </div>
            ...
            <div className="card p-6 h-fit sticky top-24 space-y-4">
              ...
              <div className="space-y-2 text-sm border-t dark:border-gray-700 pt-4">
                ...
                <div className="flex justify-between font-bold text-base dark:text-white pt-2 border-t dark:border-gray-700">
                  <span>Total</span>
              ...
              <p className="text-xs text-center text-gray-400">By placing the order you agree to our Terms & Conditions</p>
            </div>
          </div>
        </form>
      </div>
